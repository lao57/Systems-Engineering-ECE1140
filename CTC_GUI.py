...
class CTCOffice(QMainWindow, Ui_MainWindow):
    ...
    def initialize_train_monitor(self):
        ...
        sample_trains = [
            ...
            {"Train Number": 5, "Current Line": "Green", "Current Block": 7, "Commanded Speed": 60, "Commanded Authority": 40},
            {"Train Number": 9, "Current Line": "Red", "Current Block": 8, "Commanded Speed": 40, "Commanded Authority": 40},
            {"Train Number": 11, "Current Line": "Green", "Current Block": 11, "Commanded Speed": 50, "Commanded Authority": 40},
            {"Train Number": 14, "Current Line": "Green", "Current Block": 15, "Commanded Speed": 55, "Commanded Authority": 40},
            {"Train Number": 16, "Current Line": "Red", "Current Block": 18, "Commanded Speed": 65, "Commanded Authority": 40},
        ]
