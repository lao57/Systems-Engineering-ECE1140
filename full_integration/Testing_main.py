...
import track_controller.TrackControllerRed as TrackControllerRed
...
if __name__ == "__main__":
    ...
    k_p = 20
    k_i = 5
    world_time = {'day': 0, 'hour': 6, 'min': 35, 'sec': 0} #30 mins before 7 to give setup time
    ...
    red_track_controller = TrackControllerRed.TrackControllerRed()
    ...
    ctc_gui = CTCGUI(ctc=ctc, ctc_office=ctc_office,
                     ...
                     red_track_controller=red_track_controller)
    ctc_gui.show()
