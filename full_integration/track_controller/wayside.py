class WAYSIDE:
    def __init__(self, switches, lights, crossings, stop_blocks, dont_spawn_flag ,logic_function, prev_switch_states, block_authorities):
        """
        ...
        self.dont_spawn_flag = dont_spawn_flag
